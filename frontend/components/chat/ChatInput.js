...
const ChatInput = forwardRef(
  (
    ...
    const calculateMentionPosition = useCallback((textarea, atIndex) => {
      ...
      measureDiv.style.fontWeight =
        window.getComputedStyle(textarea).fontWeight;
      measureDiv.style.letterSpacing =
        window.getComputedStyle(textarea).letterSpacing;
      measureDiv.style.textTransform =
        window.getComputedStyle(textarea).textTransform;
        ...
        >
          <div className="chat-input">
            ...
            <div className="chat-input-toolbar">
              <MarkdownToolbar onAction={handleMarkdownAction} size="md" />
            </div>
            ...
            <div className="chat-input-main" style={{ position: "relative" }}>
              ...
              >
                <SendIcon size={20} />
                <span style={{ marginLeft: "var(--vapor-space-100)" }}>
                  보내기
                </span>
              </Button>
            </div>
